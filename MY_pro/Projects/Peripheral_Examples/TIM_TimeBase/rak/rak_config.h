...
#define wifi_SCAN_SSID			    "MIS"				   //@ null string ("") scans all ssidsTP-LINK_2.4GHz
#define wifi_CONNECT_SSID		    "MIS"			   //@ SSID to join to in 2.4GHz 
#define wifi_SCAN_CHANNEL		    0				              //@ 0 scans all channels	1-11

#define wifi_GET_SCAN_NUM		     3			   //@ 0 get scan result number

#define wifi_PSK				         "123456789"                //"1234567890"	lthonway303550		   //@ If we are using WPA2, this is the key
