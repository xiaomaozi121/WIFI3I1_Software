...
#define wifi_AP_STATION_MODE        0				  //0 station  1 AP	 2 ADHOC

#define wifi_SCAN_SSID			    "BHKS"//"MIS"				   //@ null string ("") scans all ssidsTP-LINK_2.4GHz
#define wifi_CONNECT_SSID		    "BHKS"//"MIS"			   //@ SSID to join to in 2.4GHz 
#define wifi_SCAN_CHANNEL		    0				              //@ 0 scans all channels	1-11

#define wifi_GET_SCAN_NUM		     3			   //@ 0 get scan result number


#define wifi_PSK				        "pranus123"// "123456789"                //"1234567890"	lthonway303550		   //@ If we are using WPA2, this is the key
...
#define wifi_AP_BRODCAST_ENABLE         0                           //  0: no hidden	 1:hidden
 ...
 /* Set IP  CONFIG */
#define wifi_IPDHCP_MODE_ENABLE			0//1//	   			  // station 0:dhcp 1:static
#define wifi_IPSTATIC_IP_ADDRESS			"192.168.1.132"
